$(function() {
	...
	var updateVideos = function(videos) {
		videos.forEach(function(r) {
			var str ='<tr><td>'+r.id+'</td><td class="font-bold text-left">'+r.title+'</td><td>'+r.commentCount+'</td><td><div class="dropdown"><a href="javascript:;" title="" class="btn medium bg-blue" data-toggle="dropdown"><span class="button-content"><i class="glyph-icon font-size-11 icon-cog"></i><i class="glyph-icon font-size-11 icon-chevron-down"></i></span></a><ul class="dropdown-menu float-right"><li><a href="javascript:;" title=""  id="video-notice"><i class="glyph-icon icon-eye-open mrg5R"></i> 查看公告</a></li><li><a href="javascript:;" title="" id="searchcomment"><i class="glyph-icon icon-eye-open mrg5R"></i> 查看评论</a></li><li><a href="javascript:;" title="" id="addIps"><i class="glyph-icon icon-eye-open mrg5R"></i> 添加访问量</a></li><li class="divider"></li><li><a href="javascript:;" title="" id="addProgram"><i class="glyph-icon icon-eye-open mrg5R"></i> 添加节目</a></li><li class="divider"></li><li><a href="javascript:;" class="font-red" title=""><i class="glyph-icon icon-remove mrg5R"></i> 删除</a></li></ul></div></td></tr>';
			...
			e.find("#addProgram").click(function() {
				location.href = "video-program.html?video_id="+r.id+"&user_id="+user_id+"&privilege="+privilege;
			});
